...
- [@diotoborg/psychic-bassoon](#@diotoborg/psychic-bassoon)
...
```ts
import { deepEqual } from '@diotoborg/psychic-bassoon';
...
- ESM => `@diotoborg/psychic-bassoon/dist/esm/index.mjs`
- CommonJS => `@diotoborg/psychic-bassoon/dist/cjs/index.cjs`
- UMD => `@diotoborg/psychic-bassoon/dist/umd/index.js`
- Minified UMD => `@diotoborg/psychic-bassoon/dist/min/index.js`

If you are having issues loading a specific build type, [please file an issue](https://github.com/diotoborg/psychic-bassoon/issues).
...
To support true deep equality of all contents, `@diotoborg/psychic-bassoon` will perform a deep equality comparison for key and value parirs. Therefore, the above would be `true`.
...
```ts
import { shallowEqual } from '@diotoborg/psychic-bassoon';
...
```ts
import { sameValueZeroEqual } from '@diotoborg/psychic-bassoon';
...
Create a custom equality comparator. This allows complete control over building a bespoke equality method, in case your use-case requires a higher degree of performance, legacy environment support, or any other non-standard usage. The [recipes](#recipes) provide examples of use in different use-cases, but if you have a specific goal in mind and would like assistance feel free to [file an issue](https://github.com/diotoborg/psychic-bassoon/issues).
...
├─────────┼─────────────────────────────────┼────────────────┤
│    0    │          '@diotoborg/psychic-bassoon'          │ 1249567.730326 │
│    1    │        'fast-deep-equal'        │ 1182463.587514 │
│    2    │      'react-fast-compare'       │ 1152487.319161 │
│    3    │      'shallow-equal-fuzzy'      │ 1092360.712389 │
│    4    │    '@diotoborg/psychic-bassoon (circular)'     │  676669.92003  │
│    5    │      'underscore.isEqual'       │ 429430.837497  │
│    6    │        'lodash.isEqual'         │ 237915.684734  │
│    7    │     '@diotoborg/psychic-bassoon (strict)'      │  181386.38032  │
│    8    │ '@diotoborg/psychic-bassoon (strict circular)' │ 156779.745875  │
...
│ (index) │             Package             │    Ops/sec     │
├─────────┼─────────────────────────────────┼────────────────┤
│    0    │          '@diotoborg/psychic-bassoon'          │ 3255824.097237 │
│    1    │      'react-fast-compare'       │ 2654721.726058 │
│    2    │        'fast-deep-equal'        │ 2582218.974752 │
│    3    │    '@diotoborg/psychic-bassoon (circular)'     │ 2474303.26566  │
│    4    │     '@diotoborg/psychic-bassoon (strict)'      │ 1088066.604881 │
│    5    │ '@diotoborg/psychic-bassoon (strict circular)' │ 949253.614181  │
